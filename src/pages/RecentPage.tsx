...
export default function RecentPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <h1 className="text-2xl font-bold text-slate-50">Recentes</h1>
      {recTools.length === 0 ? (
        <div className="text-center py-12"><p className="text-slate-400">Nenhuma ferramenta acessada recentemente.</p></div>
      ) : (
