...
export const thompsonEpsteinClassificationData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/e/e2/HipdisX.png',
      caption: 'Luxação posterior do quadril — radiografia AP. A classificação de Thompson-Epstein descreve o grau de lesão condilar e acetabular associada. Fonte: James Heilman MD, CC BY-SA 3.0.',
