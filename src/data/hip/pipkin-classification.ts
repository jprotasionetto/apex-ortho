  ...
  referenceImages: [
    {
      ...
      caption: 'Luxação do quadril — radiografia AP. As fraturas de Pipkin ocorrem em associação com luxação posterior do quadril. Fonte: James Heilman MD, CC BY-SA 3.0.',
