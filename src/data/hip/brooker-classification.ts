...
export const brookerClassificationData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/b/b9/Heterotopic_Ossification_Hip1.JPG',
      caption: 'Ossificação heterotópica peri-articular do quadril — radiografia AP mostrando formação óssea ectópica (correspondente a Brooker Grau II–III). Fonte: Wikimedia Commons, CC BY-SA 3.0.',
      source: 'Wikimedia Commons — CC BY-SA 3.0'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/9/9c/X-ray_of_pelvis_with_total_arthroplasty.jpg',
      caption: 'Pelve pós-artroplastia total do quadril — radiografia AP bilateral (contexto de avaliação de Brooker pós-ATQ). Fonte: Wikimedia Commons, CC0.',
