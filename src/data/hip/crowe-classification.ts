  ...
  referenceImages: [
    {
      ...
      caption: 'Pelve pós-artroplastia total do quadril bilateral — exemplo de reconstrução em displasia (contexto da classificação de Crowe). Fonte: Wikimedia Commons, CC0.',
