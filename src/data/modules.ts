...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'elbow', name: 'Cotovelo', description: 'Ferramentas clinicas para o cotovelo', icon: 'Radius', color: '#8B5CF6', toolCount: 11 },
  ...
  { id: 'foot', name: 'Pe e Tornozelo', description: 'Ferramentas clinicas para pe e tornozelo', icon: 'Footprints', color: '#F97316', toolCount: 13 },
