...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'elbow', name: 'Cotovelo', description: 'Ferramentas clinicas para o cotovelo', icon: 'Radius', color: '#8B5CF6', toolCount: 10 },
  ...
  { id: 'knee', name: 'Joelho', description: 'Ferramentas clinicas para o joelho', icon: 'Disc', color: '#10B981', toolCount: 16 },
  { id: 'spine', name: 'Coluna', description: 'Ferramentas clinicas para a coluna', icon: 'Layers', color: '#6366F1', toolCount: 17 },
  { id: 'foot', name: 'Pe e Tornozelo', description: 'Ferramentas clinicas para pe e tornozelo', icon: 'Footprints', color: '#F97316', toolCount: 12 },
  ...
  { id: 'universal', name: 'Universal', description: 'Ferramentas transversais e perioperatorias', icon: 'Globe', color: '#64748B', toolCount: 15 },
];
