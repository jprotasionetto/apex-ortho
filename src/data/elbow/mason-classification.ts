  ...
  referenceImages: [
    {
      ...
      caption: 'TC da cabeça do rádio — mostrando fratura articular (Classificação de Mason: I=não deslocada, II=desvio, III=cominutiva). Fonte: Wikimedia Commons.',
      source: 'Wikimedia Commons'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/RadHeadFracMark.png',
      caption: 'Radiografia de fratura da cabeça do rádio — incidência AP com marcação do traço de fratura. Fonte: Wikimedia Commons.',
      source: 'Wikimedia Commons'
    },
  ],
  grades: [
