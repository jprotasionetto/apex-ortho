...
export const neerProximalHumerusData: ClassificationData = {
  ...
  author: 'Neer',
  year: 1970,
  epidemiology: 'Fraturas do úmero proximal representam ~5–6% de todas as fraturas do esqueleto e ~45% das fraturas do úmero. Terceira fratura mais comum no idoso (após quadril e punho). Incidência: ~70/100.000/ano; dobra a cada década após 50 anos. Relação mulher:homem de 3:1 acima de 65 anos. Distribuição: ~80% são Neer 1 parte (minimamente deslocadas) — tratamento conservador; ~15% são 2 partes; ~3% são 3 partes; ~2% são 4 partes. Fratura-luxação associada em ~5% dos casos. Risco de NAV: 1 parte < 5%; 2 partes 10–25% (colo anatômico); 3 partes 15–25%; 4 partes > 90% (exceto variante valgo impactada: ~30%). Fraturas por alta energia em jovens (20–40 anos) representam minoria mas com lesões associadas (neurovascular, manguito rotador).',
  mechanism: 'Mecanismo bimodal: (1) Trauma de baixa energia — queda da própria altura com apoio no membro estendido ou impacto direto no ombro (idosos, mulheres com osteoporose). Força transmitida axialmente à cabeça umeral. (2) Trauma de alta energia — acidente automobilístico, queda de altura (jovens). Pode incluir luxação glenoumeral (fratura-luxação). Forças deformantes após a fratura: tubérculo maior tracionado pelo manguito rotador posterior (infraespinal + redondo menor) → superiormente e posteriormente; tubérculo menor pelo subescapular → anteriormente; diáfise pelo peitoral maior → anteriormente e medialmente; a cabeça é girada pelo tubérculo NÃO deslocado. Compreender estas forças explica o padrão de 3 partes: com tubérculo maior deslocado, a cabeça gira em rotação interna (subescapular intacto) — e vice-versa no tubérculo menor.',
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/4/42/ProxHumeralFracture.png',
      caption: 'Fratura do úmero proximal — radiografia mostrando comprometimento da tuberosidade maior (Neer 2 partes). Fonte: James Heilman MD, CC BY-SA 4.0.',
      source: 'Wikimedia Commons — CC BY-SA 4.0 (James Heilman MD)'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/f/f4/Proxhumerousfrac.png',
      caption: 'Fratura do úmero proximal — segunda projeção radiográfica. Fonte: James Heilman MD, CC BY-SA 3.0.',
