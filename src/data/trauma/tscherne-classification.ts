...
export const tscherneClassificationData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/9/95/Pilon_fracture_xray.jpg',
      caption: 'Fratura da tíbia com lesão de tecidos moles associada — o timing cirúrgico na classificação de Tscherne C2–C3 depende do estado dos tecidos moles. Fonte: Wikimedia Commons, CC BY-SA 4.0.',
