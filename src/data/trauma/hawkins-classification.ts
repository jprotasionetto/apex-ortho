...
export const hawkinsClassificationData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/f/ff/Talar_Fractures.jpg',
      caption: 'Fraturas do tálus — radiografia mostrando padrões de fratura do colo (relevante para Classificação de Hawkins). Fonte: Wikimedia Commons, CC BY-SA 4.0.',
