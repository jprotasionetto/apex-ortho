...
export const gartlandClassificationData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/f/fc/Gartland_Classification.jpg',
      caption: 'Classificação de Gartland das fraturas supracondilianas do úmero — diagrama mostrando Tipos I, II e III com progressão do desvio posterior. Fonte: Wikimedia Commons, CC BY-SA 4.0.',
