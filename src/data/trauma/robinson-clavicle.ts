...
export const robinsonClavicleData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Clavicle_fracture.jpg',
      caption: 'Fratura da clavícula — radiografia AP mostrando fratura do terço médio com desvio (mais comum, equivalente Robinson 2A–2B). Fonte: Wikimedia Commons.',
