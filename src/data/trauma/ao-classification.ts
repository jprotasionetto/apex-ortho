  ...
  referenceImages: [
    {
      ...
      caption: 'Padrões de fratura — o princípio hierárquico AO (A=simples, B=cunha, C=cominutivo) se aplica a diáfises e segmentos terminais (A=extraarticular, B=articular parcial, C=articular completa). Fonte: Wikimedia Commons, CC BY-SA 4.0.',
