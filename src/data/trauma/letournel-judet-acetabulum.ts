...
export const letournelJudetAcetabulumData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/3/3e/Acetabulum_%28model%29.jpg',
      caption: 'Modelo anatômico do acetábulo — mostrando as duas colunas (anterior e posterior) de Letournel e a anatomia da cavidade acetabular. Fonte: Wikimedia Commons, CC BY-SA 3.0.',
      source: 'Wikimedia Commons — CC BY-SA 3.0'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/c/cd/Acet_-_Post_wall_01.jpg',
      caption: 'Fratura da parede posterior do acetábulo (Letournel Elementar 1 — mais comum) — radiografia oblíqua obturatriz. Fonte: Wikimedia Commons.',
