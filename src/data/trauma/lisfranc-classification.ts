...
export const lisfrancClassificationData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/1/1e/LisFrancArrow.png',
      caption: 'Lesão de Lisfranc — radiografia DP com seta indicando a diástase entre 1º e 2º metatarsos (sinal de lesão ligamentar de Lisfranc). Fonte: Wikimedia Commons, CC BY-SA 4.0.',
      source: 'Wikimedia Commons — CC BY-SA 4.0'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/5/5c/Lisfranc_fracture.jpg',
      caption: 'Fratura-luxação de Lisfranc — radiografia mostrando descontinuidade da linha de Lisfranc e fratura da base do 2º metatarso. Fonte: Wikimedia Commons, CC BY 3.0.',
