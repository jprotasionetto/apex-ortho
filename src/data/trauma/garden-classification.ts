  ...
  referenceImages: [
    {
      ...
      caption: 'Fratura do colo femoral — esboço esquemático mostrando o traço subcapital (contexto Garden). Fonte: Wikimedia Commons.',
      source: 'Wikimedia Commons — CC BY 2.5'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/d/d3/Hip_fracture_classification.svg',
      caption: 'Classificação das fraturas do quadril: zonas intracapsular (colo femoral / Garden) e extracapsular (trocantéricas). Fonte: Mikael Häggström, CC0.',
