...
export const laugeHansenData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/c/ca/Supination-external_rotation_ankle_fracture-dislocation.png',
      caption: 'Fratura-luxação por supinação-rotação externa (SER) — padrão Lauge-Hansen mais comum. TC + radiografia. Fonte: Wikimedia Commons, CC BY 4.0.',
      source: 'Wikimedia Commons — CC BY 4.0'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/e/e3/Pronation-external_rotation_ankle_fracture-dislocation.png',
      caption: 'Fratura-luxação por pronação-rotação externa (PER) — equivalente Lauge-Hansen Weber C. Fonte: Wikimedia Commons, CC BY 4.0.',
      source: 'Wikimedia Commons — CC BY 4.0'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Supination-adduction_ankle_fracture-dislocation.png',
      caption: 'Fratura-luxação por supinação-adução (SAD) — fratura abaixo da sindesmose (Weber A). Fonte: Wikimedia Commons, CC BY 4.0.',
      source: 'Wikimedia Commons — CC BY 4.0'
    },
  ],
  grades: [
