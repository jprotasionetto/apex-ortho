...
export const weberClassificationData: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/0/06/Weber_Classification_-_latin.svg',
      caption: 'Classificação de Danis-Weber: diagrama esquemático dos Tipos A (infrassindesmal), B (transsindesmal) e C (suprassindesmal). Fonte: DrFO.Tn, CC BY 4.0.',
      source: 'Wikimedia Commons — CC BY 4.0'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/e/ee/Danis%E2%80%93Weber_classification_on_X-ray.jpg',
      caption: 'Classificação de Danis-Weber sobreposta em radiografia do tornozelo, com nível sindesmosal de referência. Fonte: Mikael Häggström, CC0.',
