  ...
  referenceImages: [
    {
      ...
      caption: 'Radiografia do joelho — mostrando a patela em incidência AP. A classificação AO/OTA da patela usa o mesmo princípio hierárquico A–B–C. Fonte: Wikimedia Commons, CC BY-SA 4.0.',
