...
export const sandersClassificationData: ClassificationData = {
  ...
  author: 'Sanders',
  year: 1992,
  epidemiology: 'Fraturas do calcâneo representam ~60% de todas as fraturas do tarso e ~2% de todas as fraturas do esqueleto. Incidência: ~11/100.000/ano. Predominância masculina 3:1, pico 30–50 anos (homens em trabalhos com risco de queda de altura). Distribuição: ~60–65% intra-articulares (comprometimento da faceta posterior — classificadas por Sanders) e ~35% extra-articulares (beak fractures, avulsões do tendão de Aquiles, fraturas do sustentáculo). Mecanismo: queda de altura = 70% dos casos (média de 2–4 metros). Lesões associadas: fundamental conhecer a "tríade da queda de altura": calcâneo bilateral em 10–15% (RX bilateral obrigatório), fratura da coluna lombar L1–L2 por compressão axial em 10%, fratura do calcâneo contralateral ou tornozelo em 10%. Distribuição de Sanders: I ~20%, II ~50%, III ~25%, IV ~5%. Resultados cirúrgicos Sanders II: excelentes/bons 80–86%. Sanders III: bons 60–70%. Sanders IV: artrodese subtalar primária tem resultados superiores à RAFI em múltiplos estudos (O\'Brien, Buckley). Complicações: necrose de ferida 15–25% com abordagem lateral extensile (reduzida com abordagem in sinus tarsi/percutânea). Síndrome de impactação do calcâneo-fíbula (peroneal tendon impingement) em 30–50% dos Sanders III–IV não tratados → sequela por redução de altura do calcâneo + aumento do ângulo de Böhler.',
  mechanism: 'Biomecânica da fratura do calcâneo: impacto axial pelo peso corporal → calcâneo comprimido entre tálus (de cima) e chão (de baixo) → LINHA DE FRATURA PRIMÁRIA CORONAL: atravessa o calcâneo de posterior-superior para anterior-inferior, separando sustentáculo tali (medial, fixo aos ligamentos talocalcâneos) do processo posterior (lateral, que se desvia lateralmente e caudalmente). Progressão com mais energia → LINHA DE FRATURA SECUNDÁRIA: começa medial ao sulco do tendão flexor longo do hálux e vai obliquamente para a faceta posterior → divide a faceta posterior em fragmentos: 1 fragmento = Sanders II; 2 fragmentos = Sanders III; 3 fragmentos = Sanders IV. A CLASSIFICAÇÃO DE SANDERS É BASEADA EM TC CORONAL: número de linhas de fratura na faceta posterior + localização relativa ao sustentáculo. O sustentáculo tali é o FRAGMENTO CONSTANTE (anchored fragment) — sempre permanece articulado ao tálus por ligamentos resistentes → serve como referência de redução. Dois parâmetros radiográficos críticos: (1) Ângulo de Böhler (normal 20–40°): reduzido na fratura intra-articular; restauração cirúrgica > 0° correlaciona com resultados funcionais. (2) Ângulo de Gissane (normal 120–145°): aumentado na fratura pelo colapso da faceta anterior.',
  grades: [
    {
      id: 'sanders-i',
