  ...
  referenceImages: [
    {
      ...
      caption: 'Úlcera neuropática do calcanhar em pé diabético — lesão de profundidade intermediária (Wagner Grau 2 / Texas Estágio B). Fonte: Wikimedia Commons, CC BY 3.0.',
