  ...
  referenceImages: [
    {
      ...
      caption: 'Fratura do fêmur proximal — a classificação ASA estratifica o risco cirúrgico pré-operatório para qualquer procedimento ortopédico, incluindo artroplastias e fixações de fraturas. Fonte: Wikimedia Commons, CC BY-SA 3.0.',
