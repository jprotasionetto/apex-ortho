...
export const woundClassification: ClassificationData = {
  ...
  referenceImages: [
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/7/72/Gustilo_type_2_fracture.png',
      caption: 'Fratura exposta — grau de contaminação e lesão de tecidos moles classificado pelo NRC/CDC (equivalente à ferida Classe III/IV). Fonte: Wikimedia Commons, CC BY-SA 3.0.',
