  ...
  referenceImages: [
    {
      ...
      caption: 'Dermátomos e território nervoso — mapa sensitivo relevante para localização topográfica nas lesões nervosas periféricas (Seddon/Sunderland). Fonte: Wikimedia Commons, Domínio Público.',
