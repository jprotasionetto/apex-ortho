  ...
  referenceImages: [
    {
      ...
      caption: 'Radiografia do joelho em carga — padrão-ouro para avaliação do estreitamento do espaço articular (Classificação de Ahlbäck). Fonte: Wikimedia Commons, CC BY-SA 4.0.',
      source: 'Wikimedia Commons — CC BY-SA 4.0'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/f/f5/Gonarthrose.jpg',
      caption: 'Gonartrose — radiografia mostrando diminuição do espaço articular medial e osteófitos (correspondente a Ahlbäck Grau III–IV). Fonte: Wikimedia Commons, CC BY-SA 4.0.',
      source: 'Wikimedia Commons — CC BY-SA 4.0'
    },
  ],
  grades: [
