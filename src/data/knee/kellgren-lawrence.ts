  ...
  referenceImages: [
    {
      ...
      caption: 'Radiografia do joelho em carga — a classificação de Kellgren-Lawrence avalia estreitamento do espaço articular, osteófitos, esclerose e cistos subcondrais. Fonte: Wikimedia Commons, CC BY-SA 4.0.',
      source: 'Wikimedia Commons — CC BY-SA 4.0'
    },
    {
      src: 'https://upload.wikimedia.org/wikipedia/commons/f/f5/Gonarthrose.jpg',
      caption: 'Gonartrose avançada — estreitamento medial acentuado e osteófitos (Kellgren-Lawrence Grau III–IV). Fonte: Wikimedia Commons, CC BY-SA 4.0.',
      source: 'Wikimedia Commons — CC BY-SA 4.0'
    },
  ],
  grades: [
