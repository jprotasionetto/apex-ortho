  ...
  referenceImages: [
    {
      ...
      caption: 'Tumor ósseo da tíbia — radiografia mostrando lesão agressiva com destruição cortical (contexto Campanacci/Lodwick grau III). Fonte: Wikimedia Commons, CC BY-SA 4.0.',
