...
import { DenisColumnsSVG } from '@/components/svg/spine/DenisColumnsSVG.tsx';
  ...
  return (
    <div className="space-y-6">
      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4 overflow-hidden">
        <DenisColumnsSVG activeGrade={selected} onGradeSelect={setSelected} interactive={true} showLabels={true} />
      </div>
