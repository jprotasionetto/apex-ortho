...
export default function AoClassificationTool() {
  ...
  return (
    <div className="space-y-6">
      ...
      {aoClassificationData.clinicalPearl && <Alert type="info">{aoClassificationData.clinicalPearl}</Alert>}
      {aoClassificationData.pitfall && <Alert type="caution">{aoClassificationData.pitfall}</Alert>}
    </div>
  );
}
