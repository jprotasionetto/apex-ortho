...
export default function TscherneClassificationTool() {
  ...
  return (
    <div className="space-y-6">
      ...
      {tscherneClassificationData.clinicalPearl && <Alert type="info">{tscherneClassificationData.clinicalPearl}</Alert>}
      {tscherneClassificationData.pitfall && <Alert type="caution">{tscherneClassificationData.pitfall}</Alert>}
    </div>
  );
}
