...
export default function GardenClassificationTool() {
  ...
  return (
    <div className="space-y-6">
      ...
      {gardenClassificationData.clinicalPearl && <Alert type="info">{gardenClassificationData.clinicalPearl}</Alert>}
      {gardenClassificationData.pitfall && <Alert type="caution">{gardenClassificationData.pitfall}</Alert>}
    </div>
  );
}
