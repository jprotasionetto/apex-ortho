...
import { umeroDiafisarioAOData } from '@/data/trauma/umero-diafisario-ao.ts';
import { Alert } from '@/components/ui/Alert.tsx';

const colorMap: Record<string, string> = { safe: '#22C55E', caution: '#F59E0B', danger: '#EF4444' };

const images = [
  { src: '/images/manual-trauma/page79_img1.png', caption: 'AO 12 — Classificação diafisária do úmero: A (simples), B (cunha), C (multifragmentária)' },
];

export default function UmeroDiafisarioAOTool() {
  const [selected, setSelected] = useState<string | null>(null);
  const data = umeroDiafisarioAOData;
