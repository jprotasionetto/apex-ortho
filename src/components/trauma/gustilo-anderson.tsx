...
export default function GustiloAndersonTool() {
  ...
  return (
    <div className="space-y-6">
      {/* Algoritmo de conduta — Manual SBOT */}
      <div className="bg-[#111111] border border-[rgba(212,175,55,0.2)] rounded-xl p-4">
        <p className="text-xs text-[#D4AF37] font-medium uppercase tracking-wider mb-3">
          Fraturas Expostas — Manual SBOT
        </p>
        <div className="max-w-sm mx-auto">
          <div className="rounded-lg overflow-hidden border border-[rgba(255,255,255,0.06)]">
            <img src="/images/manual-trauma/page30_img1.png" alt="Algoritmo de conduta — lesão arterial e estado hemodinâmico" className="w-full h-auto object-contain bg-[#0A0A0A]" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
            <div className="px-2 py-1 bg-[#0A0A0A]"><p className="text-xs text-gray-400 leading-tight">Algoritmo de conduta — avaliação do estado hemodinâmico e controle de danos</p></div>
          </div>
        </div>
      </div>
