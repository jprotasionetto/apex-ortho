...
import { pilonRuediAllgowerData } from '@/data/trauma/pilon-ruedi-allgower.ts';
import { Alert } from '@/components/ui/Alert.tsx';

export default function PilonRuediAllgowerTool() {
  ...
  return (
    <div className="space-y-6">
      ...
      {pilonRuediAllgowerData.clinicalPearl && <Alert type="info">{pilonRuediAllgowerData.clinicalPearl}</Alert>}
      {pilonRuediAllgowerData.pitfall && <Alert type="caution">{pilonRuediAllgowerData.pitfall}</Alert>}
    </div>
  );
}
