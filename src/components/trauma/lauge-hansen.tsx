...
export default function LaugeHansenTool() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Imagens do Manual — Fraturas do Tornozelo (pp. 198–200) */}
      <div className="bg-[#111111] border border-[rgba(212,175,55,0.2)] rounded-xl p-4">
        <p className="text-xs text-[#D4AF37] font-medium uppercase tracking-wider mb-3">
          Fraturas do Tornozelo — Manual SBOT (pp. 198–200)
        </p>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          {[
            ...
            { src: '/images/manual-trauma/page200_img1.png', caption: 'Padrões de fratura — mecanismo de lesão' },
          ].map((img) => (
