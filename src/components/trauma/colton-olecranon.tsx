...
import { coltonOlecranonData } from '@/data/trauma/colton-olecranon.ts';
import { Alert } from '@/components/ui/Alert.tsx';

const colorMap: Record<string, string> = { safe: '#22C55E', caution: '#F59E0B', danger: '#EF4444' };

const images = [
  { src: '/images/manual-trauma/page88_img1.png', caption: 'Classificação de Colton — tipos de fratura do olécrano' },
  { src: '/images/manual-trauma/page89_img1.png', caption: 'Traços de fratura — visão lateral' },
  { src: '/images/manual-trauma/page89_img2.png', caption: 'Mayo Tipo II — fratura deslocada estável' },
  { src: '/images/manual-trauma/page89_img3.png', caption: 'Mayo Tipo III — fratura-luxação instável' },
  { src: '/images/manual-trauma/page90_img1.png', caption: 'Osteossíntese com banda de tensão (AO)' },
  { src: '/images/manual-trauma/page90_img2.png', caption: 'Fixação com placa — fratura cominutiva' },
];

export default function ColtonOlecranonTool() {
  const [selected, setSelected] = useState<string | null>(null);
  const data = coltonOlecranonData;
