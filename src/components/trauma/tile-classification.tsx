...
export default function TileClassificationTool() {
  ...
  return (
    <div className="space-y-6">
      ...
      {tileClassificationData.clinicalPearl && <Alert type="info">{tileClassificationData.clinicalPearl}</Alert>}
      {tileClassificationData.pitfall && <Alert type="caution">{tileClassificationData.pitfall}</Alert>}
    </div>
  );
}
