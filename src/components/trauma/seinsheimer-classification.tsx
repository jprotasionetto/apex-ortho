...
import { seinshheimerClassificationData } from '@/data/trauma/seinsheimer-classification.ts';
...
export default function SeinshheimerClassificationTool() {
  const [selected, setSelected] = useState<string | null>(null);
  const data = seinshheimerClassificationData;
  ...
  return (
    <div className="space-y-6">
      <div className="bg-[#111111] border border-[rgba(212,175,55,0.2)] rounded-xl p-4">
        <p className="text-xs text-[#D4AF37] font-medium uppercase tracking-wider mb-3">Seinsheimer (Subtrocantérica) — Manual SBOT (pp. 165–168)</p>
